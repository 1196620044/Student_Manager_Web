    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#delete").click(function(){
                ...
                if(selectRow == null){
                    $.messager.alert("消息提醒", "请选择课程进行退课操作!", "warning");
                } else{
                    var id = selectRow.id;
                        ...
                        if(r){
                            $.ajax({
                                ...
                                success: function(msg){
                                    if(msg == "success"){
                                        $.messager.alert("消息提醒","退课成功!","info");
                                        //刷新表格
                                        $("#dataList").datagrid("reload");
                                    }else if(msg == "not found"){
                                        $.messager.alert("消息提醒","不存在该选课记录!","info");
                                    }else{
                                        $.messager.alert("消息提醒","退课失败!","warning");
                                        return;
                                    }
                                }
                            });
...
<!-- 工具栏 -->
<div id="toolbar">
    <div style="float: left;"><a id="add" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">选课</a></div>
